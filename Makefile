...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/DryPeng/clashT/constant.Version=$(VERSION)" \
		-X "github.com/DryPeng/clashT/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
